...
class SingUpScreenProfesio extends StatefulWidget {
  File image;
  SingUpScreenProfesio({Key key}) : super(key: key);

  @override
  _SingUpScreenProfesioState createState() => _SingUpScreenProfesioState();
}



class _SingUpScreenProfesioState extends State<SingUpScreenProfesio> {
  File _imageFile;
  ...
  Future _addData(BuildContext context) async{
    if( 
      ...
      if(!controllerMail.text.contains("@")){
          ...
          if(controllerPassword.text.length<8){
            ...
            if(_isChecked==false){
              ...
              if(datauser.length!=0){
                ...
                final response2 = await http.post("http://0.0.0.0/servicio/addprofesional.php", body: {
